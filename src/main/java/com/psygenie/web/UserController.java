...
import com.psygenie.model.dto.UpdateAppClientDto;
import com.psygenie.model.dto.UpdateBusinessDto;
...
import com.psygenie.model.jwt.JwtRequest;
import com.psygenie.model.jwt.JwtResponse;
import com.psygenie.security.PsyGenieUserDetailsService;
import com.psygenie.service.NotificationService;
import com.psygenie.service.UserService;
import com.psygenie.utility.JWTUtility;
...
public class UserController {
    ...
    private final PsyGenieUserDetailsService psyGenieUserDetailsService;

    @Autowired
    public UserController(UserService userService, PasswordEncoder passwordEncoder, NotificationService notificationService, JWTUtility jwtUtility, AuthenticationManager authenticationManager, PsyGenieUserDetailsService psyGenieUserDetailsService) {
        this.userService = userService;
        this.passwordEncoder = passwordEncoder;
        this.notificationService = notificationService;
        this.jwtUtility = jwtUtility;
        this.authenticationManager = authenticationManager;
        this.psyGenieUserDetailsService = psyGenieUserDetailsService;
    }
    ...
    public JwtResponse authenticate(@RequestBody JwtRequest jwtRequest) throws Exception {
        ...
        final UserDetails userDetails
                = psyGenieUserDetailsService.loadUserByUsername(jwtRequest.getUsername());
